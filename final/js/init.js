...
function addtoPanel(data) {
    ...
    <h3>Story from: ${data["If applicable, what companies did/do you work under and what were/are your job titles? "]}</h3>
    ...
    <p class="left">Helpful resources: ${data["Are there any people, campus resources, or online resources that you have found helpful and/or utilized to find employment/internship opportunities in the US?"]}</p>
    <p class="left">Words of advice: ${data["Do you have any advice for current international students at UCLA or is there anything else you'd like to share about your experiences? "]}</p>
    </div>`
